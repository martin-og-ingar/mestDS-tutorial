# mestDS - Domain-specific Language (DSL) Documentation
...
This documentation provides an overview of the **domain-specific language** that allows the user to define `simulators` an `evaluators`.

If the documentation feels overwhelming, a good strating point for using the framework is the [introduction to mestDS](tutorial.md).
